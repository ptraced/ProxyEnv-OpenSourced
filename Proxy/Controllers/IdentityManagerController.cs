...
namespace Proxy.Controllers
{
    public class IdentityManager : Controller
    {
        ...
        public IdentityManager(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, ILogger<IdentityManager> logger, ApplicationDbContext context)
        {
